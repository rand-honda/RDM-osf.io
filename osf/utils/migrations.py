...
FORMAT_TYPE_TO_TYPE_MAP = {
    ...
    (None, 'choose2'): 'single-select-input',
    (None, 'choose3'): 'single-select-input',
    ('osf-upload-open', 'osf-upload'): 'file-input',
    ('osf-upload-toggle', 'osf-upload'): 'file-input',
    ('singleselect', 'choose'): 'single-select-input',
    ('singleselect', 'choose2'): 'single-select-input',
    ('singleselect', 'choose3'): 'single-select-input',
    ('text', 'string'): 'short-text-input',
    ('text2', 'string'): 'short-text-input',
    ('text3', 'string'): 'short-text-input',
    ('text4', 'string'): 'short-text-input',
    ('text5', 'string'): 'short-text-input',
    ('text6', 'string'): 'short-text-input',
    ('text7', 'string'): 'short-text-input',
    ('text8', 'string'): 'short-text-input',
    ('text9', 'string'): 'short-text-input',
    ...
    ('file-creators2', 'string'): 'file-creators-input',
    ('file-creators3', 'string'): 'file-creators-input',
    ('file-creators4', 'string'): 'file-creators-input',
    ('file-creators5', 'string'): 'file-creators-input',
    ('file-creators6', 'string'): 'file-creators-input',
    ('file-creators7', 'string'): 'file-creators-input',
